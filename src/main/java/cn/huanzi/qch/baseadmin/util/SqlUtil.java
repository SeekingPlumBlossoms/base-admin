                            ...
                            if (field.getType().getName().equals("java.util.Date")) {
                                //MySQL
                                    if (!StringUtils.isEmpty(minVal)) {
                                        sql.append(" and " + column + " >=  '" + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format((Date) minVal) + "'");
                                    }
                                    if (!StringUtils.isEmpty(maxVal)) {
                                        sql.append(" and " + column + " <= '" + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format((Date) maxVal) + "'");
                                    }
                                //Oracle
